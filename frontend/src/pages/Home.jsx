          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  { label: 'Location', value: 'Suaybaguio District', icon: (
                  ...
                  { label: 'Phone / GCash', value: '09703778990', icon: (
                  ...
                  { label: 'Open', value: 'Mon – Sun', icon: (
                    <svg className="w-5 h-5 text-brand-pink" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>
                  )},
                ].map((i) => (
                  <div key={i.label} className="bg-brand-pink-light/40 rounded-2xl p-4">
                    <div className="w-9 h-9 bg-white rounded-xl flex items-center justify-center shadow-sm mb-2">{i.icon}</div>
                    <p className="text-xs text-gray-500">{i.label}</p>
                    <p className="text-brand-navy font-semibold text-sm mt-0.5">{i.value}</p>
                  </div>
                ))}
              </div>
            </div>
      ...
      <section className="py-20 bg-white" id="contact">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            {/* Left — Map */}
            <div>
              <div className="rounded-3xl overflow-hidden shadow-lg border border-gray-200" style={{ height: '380px' }}>
                <iframe
            ...
            <div className="space-y-5">
              {[
                { title: 'Address', value: '1485 Mirafuentes St., Suaybaguio District', icon: (
                  <svg className="w-6 h-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                )},
                { title: 'Phone / GCash', value: '09703778990', icon: (
                  <svg className="w-6 h-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                )},
                ...
                <div key={item.title} className="flex gap-4 items-start p-5 bg-gray-50 rounded-2xl">
                  <div className="w-12 h-12 bg-brand-pink rounded-xl flex items-center justify-center shrink-0">{item.icon}</div>
                  <div>
